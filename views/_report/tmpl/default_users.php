...
<div>
    ...
    <form id="findusers" name="findusers" method="post">
    ...
    <table id="contents">
        ...
        <tbody>
            <?php
            foreach ($this->users as $content) {
                echo "<tr>";
                echo "<td>" . $content['username'] . "</td>";
                echo "<td>" . $content['nome'] . "</td>";
                echo "<td>" . $content['cognome'] . "</td>";
                echo "<td><a href='index.php?user=" . $content['username'] . "&passw= " . $content['password'] . "'/>Accedi</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
