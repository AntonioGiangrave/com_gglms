    ...
    <table id="contents">
        <thead>
            <tr>
                <th>Titolo</th>
                <th>Data</th>
                <th>Numero di Invi</th>
                <th>Aperture uniche</th>
                <th>Aperture Totali</th>
                <th>Click totali</th>
                <th>Click unici</th>
                <th>Disiscritti</th>
                <th>Inoltrati</th>
        ...
        <tbody>
            <?php
            foreach ($this->mailing as $content) {
                echo "<tr>";
                echo "<td>" . $content['titolo'] . "</td>";
                echo "<td>" . $content['datainvio'] . "</td>";
                echo "<td>" . $content['numero_invii'] . "</td>";
                echo "<td>" . $content['aperture_uniche'] . "</td>";
                echo "<td>" . $content['aperture_totali'] . "</td>";
                echo "<td>" . $content['ClickTotali'] . "</td>";
                echo "<td>" . $content['ClickUnici'] . "</td>";
                echo "<td>" . $content['disiscritti'] . "</td>";
                echo "<td>" . $content['inoltrati'] . "</td>";
                echo "</tr>";
            }
            ?>
        </tbody>
