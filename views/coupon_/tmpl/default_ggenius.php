...
<script>
  jQuery(function() {
    ...
    jQuery("button").click(function(e) {
      ...
      jQuery.get("index.php?option=com_gglms&task=check_coupon", {coupon: jQuery("#inputCoupon").val(), codiceverifica: "#GGENIUS#"},
        function(data) {
          if (data.valido) {
            jQuery(".inputCoupongroup").removeClass('error').addClass('success');
            jQuery("#inputCoupon").prop('disabled', true);
            jQuery("#inputCoupon").prop('disabled', true);
            jQuery("#mieicorsi").html(data.mieicorsi);
    ...
    <p>Per poter accedere alla piattaforma dovrai inserire nello spazio sottostante il codice coupon che hai ricevuto. </p>
    ...
    <h3>Inserisci qui il tuo codice: </h3>
     ...
     <div class="span12">
      ...
      <form class="form-horizontal">
        ...
        <div class="control-group  inputCoupongroup ">
          <label class="control-label" for="inputCoupon">Codice coupon</label>
          <div class="controls">
            <input class="input-xlarge" type="text" id="inputCoupon" placeholder="codice coupon">
