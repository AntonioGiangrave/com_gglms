...
<div id="sidepanel"  class="sidepanel hide">

 <div id="pulsanti" >

     <div id="jumper" class="pulsante"><img  width="40px" src="components/com_gglms/images/navigazione.png"/></div>
     <div id="schedacaso" class="pulsante"><img  width="40px" src="components/com_gglms/images/scheda.png"/></div>
     <div id="normativa" class="pulsante"><img width="40px"  src="components/com_gglms/images/normativa.png"/></div>
 </div>
...
<div class="container-video container-videosidepanelhide">
    <div id="boxvideo" class=" col-sm-6 ">
        <video  style="width:100%; height:100%; max-height: 100% !important;" height="100%" controls="controls" preload="none" class="img-thumbnail">
