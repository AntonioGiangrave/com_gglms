...
<div id="container">
    <div id="attestato">
        <div style="text-align: center">
            <img width="1000" src="components/com_gglms/models/libs/pdf/imgs/header.jpg" align="center" />
        </div>
        ...
        <div>
            ...
            <p>
                ...
                in qualità di {$data.cb_professionedisciplinaaltro}<br />
            ...
            <p>
                ha conseguito<br />
                N. {$data.crediti} ({$data.crediti_testo}) Crediti formativi per l'anno 2014
            </p>
            <p>
                IL RAPPRESENTANTE LEGALE DELL'ORGANIZZATORE<br />
                Dott. Paolo Macrì<br />
                <img width="100" src="components/com_gglms/models/libs/pdf/imgs/firma_macri.jpg" align="center" />
            </p>
        </div>
    </div>
</div>   