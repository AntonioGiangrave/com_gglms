...
public static function dbConnect() {
    ...
    FB::log($dbname, $dbhost, $dbuser, $dbpass, "connect");
...
$this->_db = & JFactory::getDbo();
    ...
    $result = mysql_query("select VarValue from #__gg_scormvars where ((SCOInstanceID=$SCOInstanceID) and (VarName='$safeVarName'))",$link);
...
function writeElement($VarName,$VarValue) { 
    ...
    mysql_query("update #__gg_scormvars set VarValue='$safeVarValue' where ((SCOInstanceID=$SCOInstanceID) and (VarName='$safeVarName'))",$link);
...
function initializeElement($VarName,$VarValue) {
    ...
    if (! mysql_num_rows($result)) {
        mysql_query("insert into #__gg_scormvars (SCOInstanceID,VarName,VarValue) values ($SCOInstanceID,'$safeVarName','$safeVarValue')",$link);
    }
